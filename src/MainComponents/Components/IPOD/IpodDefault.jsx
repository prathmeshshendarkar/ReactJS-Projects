    ...
    return (
        <div className='flex flex-col items-center h-[100%] px-1 py-4'>
            <div className='flex flex-col justify-around items-center bg-blue-700 w-[90%] h-[85%] rounded-md'>
                ...
                <button className='w-[50%] bg-slate-950 px-4 py-1 rounded-sm' onClick={() => handleCardComponent(!cardStatus)}>Change to Additional</button>
            </div>

            <div className='flex flex-col justify-evenly items-center bg-slate-500 mt-3 p-2 w-[90%] h-auto rounded-md'>
                <div className='text-center w-[100%]'>
                    <button className='bg-slate-950 px-4 py-1 rounded-sm' onClick={() => handleCardSettings("settings")}>Settings</button>
                </div>
                <div className='w-[100%] m-2 flex justify-evenly'>
                    <button className='bg-slate-950 px-4 py-1 rounded-sm' onClick={() => handleCardSettings("profile")}>Profile</button>
                    <button className='bg-slate-950 px-4 py-1 rounded-sm' onClick={() => handleCardSettings("contacts")}>Contacts</button>
                    <button className='bg-slate-950 px-4 py-1 rounded-sm' onClick={() => handleCardSettings("music")}>Music</button>
                </div>
            </div>
        </div>
    )
